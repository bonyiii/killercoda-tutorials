...
> Próbálja ki: `ruby ~/code/step_2_loop.rb`

## Feladat

Szerkessze a `~/code/step_2_challenge.rb` fájlt, és írjon egy `loop` ciklust, amely **5-ször** kiírja: `Ruby loop!` — a lépés akkor teljesül, ha a ciklus pontosan 5-ször írja ki a `Ruby loop!` szöveget.
